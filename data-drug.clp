...
(deffacts initial-facts
	...
	(drug-item (drug-name "Labetalol") (action "Beta- > Alpha-1 block") (side-effect "Lowers BP with limited HR increase"))
	...
	(add-side-effect (action1 "Alpha-adrenoceptor–blocking action") (action2 "produce pharmacodynamic") (new-side-effect "Addiction"))
