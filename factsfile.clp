(deffacts initial-facts
  ...
  (user-input (first-drug Piperazine) (second-drug Prazosin))
  (drug-item (drug-name Piperazine) (action q) (side-effect q))
  (drug-item (drug-name Prazosin) (action q) (side-effect r))
)