...
(drug-item (drug-name abc) (action act2) (side-effect se2))
(new-drug-flag (status TRUE))
(drug-item (drug-name xyz) (action act1) (side-effect se1))
(drug-item (drug-name "abc") (action "act1") (side-effect "se1"))
(drug-item (drug-name "xyz") (action "act2") (side-effect "se2"))
(drug-item (drug-name qwe) (action act3) (side-effect se3))
(drug-item (drug-name rty) (action act4) (side-effect se4))
